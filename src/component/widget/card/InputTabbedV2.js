...
const InputTabbed = () => {
  ...
  return (
    <TabWrapper
      ...
      tabTitle2="Wallet ID"
      tabSubtitle1="Please enter the valid bank account information that you hold"
      tabSubtitle2="Please enter a valid bank account or Wallet number that you hold"
