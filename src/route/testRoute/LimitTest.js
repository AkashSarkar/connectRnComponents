...
const LimitTest = () => {
  ...
  return (
    ...
    >
      ...
      <ButtonPrimary textColor={colors.white1} buttonColor={gradientColors.gradientPrimary} content="Set Limit" onPress={() => setUtilizedLimit(utilizedLimit + 12500)} />
      <View style={{ marginBottom: 15 }} />
      <LimitChange utilizedLimit={200} setUtilizedLimit={setUtilizedLimit} limit={5000} />
    </View>
  );
};
